...
input_files = sorted(glob.glob("../data/sequences/flow_seq_mirai_perdevice_v2/flow_seq_*.npz"))
...
np.savez(
    "../data/sequences/flow_sequences_mirai_v2_final.npz",
    X=X_final, y=y_final, scenario=np.array(all_scenario)
)
print("\nSaved to ../data/sequences/flow_sequences_mirai_v2_final.npz")
