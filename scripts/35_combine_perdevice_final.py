...
input_files = sorted(glob.glob("../data/sequences/flow_seq_mirai_perdevice/flow_seq_*.npz"))
...
np.savez(
    "../data/sequences/flow_sequences_mirai_perdevice_final.npz",
    X=X_final, y=y_final, scenario=np.array(all_scenario)
)
print()
print("Saved to ../data/sequences/flow_sequences_mirai_perdevice_final.npz")
