...
# capped class weights - same scheme that worked best previously
...
print("\n=== Classification Report (LSTM v2, with repeat-contact feature) ===")
...
torch.save(model.state_dict(), "../data/models/lstm_v2_repeatcontact.pt")
print("Model saved.")
