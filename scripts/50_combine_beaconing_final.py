...
input_files = sorted(glob.glob("../data/sequences/flow_seq_mirai_beaconing_v3/flow_seq_*.npz"))
...
np.savez(
    "../data/sequences/flow_sequences_beaconing_v3_final.npz",
    X=X_final, y=y_final, scenario=np.array(all_scenario)
)
print("\nSaved to ../data/sequences/flow_sequences_beaconing_v3_final.npz")
